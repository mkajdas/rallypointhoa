...
if(table_exists('faq')==false){
	$result = query("CREATE TABLE faq(id INTEGER PRIMARY KEY, catid INTEGER, question TEXT, answer TEXT)");
}
...
if(table_exists('file')==false){
	$result = query("CREATE TABLE file(id INTEGER PRIMARY KEY, board INTEGER, name TEXT, ext TEXT, owner INTEGER, b BLOB, t TEXT)");
}
if(table_exists('note')==false){
	$result = query("CREATE TABLE note(id INTEGER PRIMARY KEY, board INTEGER, content TEXT, owner INTEGER)");
}
