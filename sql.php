...
$mydb = new SQLiteDB('../../everythingwheatridge/' . 'wheatridge' . '.db');
$result = $mydb->query("ALTER TABLE note ADD dt INTEGER");
$result = $mydb->query("ALTER TABLE file ADD dt INTEGER");
$result = $mydb->query("ALTER TABLE faq ADD dt INTEGER");
?>
