...
<rss version="0.91">
    <channel>
        <title><?=$titleofsite?> FAQ</title>
        <description></description>
        <link><?=$addressofwebsite?>faq.php</link>
...
?><item>
            <title><?=xmlreplace(unescape_data($rr['question']))?></title>
            <link><?=$addressofwebsite?>faq.php</link>
            <description><?=xmlreplace(unescape_data(nl2br($rr['answer'])))?></description>
